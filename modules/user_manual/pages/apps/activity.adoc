...
In addition to enabling and disabling email notifications, bulk email notifications can be configured to be sent out: _As soon as possible_, _Hourly_, _Daily_, and _Weekly_.
