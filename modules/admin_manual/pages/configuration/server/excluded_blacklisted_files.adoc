...
Therefore no differenciation is made in processing as it would just return a deny at a later stage.
...
In case you try to add a file via the browser or sync a file from the client named ".snapshot",
you get a immediate ownCloud triggered deny.
====
